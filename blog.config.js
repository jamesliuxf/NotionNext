...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'jamesliu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '科技互联网博主欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jamesliu.online', // 网站地址
